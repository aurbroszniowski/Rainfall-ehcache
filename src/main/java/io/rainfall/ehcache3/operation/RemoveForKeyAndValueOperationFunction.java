 ...
 */
public class RemoveForKeyAndValueOperationFunction<K, V> implements OperationFunction<EhcacheResult> {
  ...
  public RemoveForKeyAndValueOperationFunction(final Cache<K, V> cache, final long next,

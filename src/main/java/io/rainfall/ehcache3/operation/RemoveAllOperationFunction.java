 ...
 */
public class RemoveAllOperationFunction<K, V> implements OperationFunction<EhcacheResult> {
  ...
  public RemoveAllOperationFunction(final Cache<K, V> cache, final long next, final ObjectGenerator<K> keyGenerator,

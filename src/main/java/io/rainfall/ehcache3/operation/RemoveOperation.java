...
public class RemoveOperation<K, V> implements Operation {
  ...
  public RemoveOperation(final ObjectGenerator<K> keyGenerator, final SequenceGenerator sequenceGenerator,
                         final Iterable<CacheDefinition<K, V>> cacheDefinitions) {
